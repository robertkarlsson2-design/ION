...
// LiteralValue
// ---------------------------------------------------------------------------
function literalValueToJson(v) {
    return v;
}
function literalValueFromJson(raw, ctx) {
    const obj = assertObj(raw, ctx);
    const kind = assertStr(obj['kind'], `${ctx}.kind`);
    switch (kind) {
...
function effectHandlerToJson(h) {
    return {
